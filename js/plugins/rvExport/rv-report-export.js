...
var rvExport = {
    ...
    downloadExcel : function(title, data, totalData, year){
        ...
        h = rvExport.getExportTitle(title) + rvExport.getExportHtml("", data, totalData, year);
        rvExport.excel(h, title);
    },

    printPreview : function(title, data, totalData, year){
        if(rvExport.isMobile()){
            alert('Not supported on Mobile Device');
            return;
        }
        
        var h = rvExport.getExportTitle(title) + rvExport.getExportHtml("", data, totalData, year);
    ...
    excel : function(printHTML, fileName, urlBlankPage){
        ...
        hPrint.push('  tr.table-divider > td {border-bottom:1px solid #808080;}');
		hPrint.push(' .optiondivider, .optiondivider > span {            padding: 0px 0x!important;        }');
		hPrint.push(' .optionGroup {font-weight:bold;}');
    ...
    getExportHtml : function(title, totalData, data , year){
        ...
        hPrint.push('           <thead>');
        hPrint.push('               <tr>');
        hPrint.push('               	<th colspan="3" rowspan="3">&nbsp;</th>');
        hPrint.push('               	<th rowspan="3" >Y '+(year-1)+' Result</th>');
        hPrint.push('               	<th rowspan="3" >Y '+(year)+' Plan</th>');
        hPrint.push('               	<th rowspan="3" >+/-</th>');
        hPrint.push('               	<th colspan="24">Monthly Plan & Result in Y'+(year)+' </th>');
        hPrint.push('               </tr>');
        hPrint.push('               <tr>');
        hPrint.push('               	<th colspan="2">Jan</th>');
        hPrint.push('               	<th colspan="2">Feb</th>');
        hPrint.push('               	<th colspan="2">Mar</th>');
        hPrint.push('               	<th colspan="2">Apr</th>');
        hPrint.push('               	<th colspan="2">May</th>');
        hPrint.push('               	<th colspan="2">Jun</th>');
        hPrint.push('               	<th colspan="2">Jul</th>');
        hPrint.push('               	<th colspan="2">Aug</th>');
        hPrint.push('               	<th colspan="2">Sep</th>');
        hPrint.push('               	<th colspan="2">Oct</th>');
        hPrint.push('               	<th colspan="2">Nov</th>');
        hPrint.push('               	<th colspan="2">Dec</th>');
        hPrint.push('               </tr>');
        hPrint.push('               <tr>');
        hPrint.push('               	<th>Plan</th>');
        hPrint.push('               	<th>Result</th>');
        hPrint.push('               	<th>Plan</th>');
        hPrint.push('               	<th>Result</th>');
        hPrint.push('               	<th>Plan</th>');
        hPrint.push('               	<th>Result</th>');
        ...
        for(var i=0 ; i<rowLength ; i++){
        	...
        	hPrint.push(this.getTDText(i));
        	
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(item['A_TOTAL']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(item['P_TOTAL']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(item['G_TOTAL']) + '</td>');
			
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_01']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_01']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_02']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_02']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_03']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_03']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_04']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_04']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_05']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_05']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_06']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_06']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_07']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_07']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_08']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_08']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_09']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_09']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_10']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_10']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_11']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_11']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['P_12']) + '</td>');
			hPrint.push('    <td class="tr">' + this.checkEmptyValue(obj['A_12']) + '</td>');
    ...
    checkEmptyValue: function(v){
    	return (v == '' || v == undefined || v == null)?'0':v;
    },
    
    getTDText: function(idx){
    	
    	var hPrint = '';
    	
    	if(idx == 0){
    		hPrint = '<td colspan="3" >Newly Opened</td>';
    	}else if(idx == 1){
            hPrint = '<td colspan="3" >Terminated</td>';
    	}else if(idx == 2){
    		hPrint = '<td colspan="3" >Replaced</td>';
    	}else if(idx == 3){
    		hPrint = '<td colspan="1" rowspan="7" >&nbsp;</td>';
            hPrint += '<td colspan="2" class="active" >Main Dealer</td>';
    	}else if(idx == 4){
            hPrint = '<td colspan="1" rowspan="4" >&nbsp;</td>';
            hPrint += '<td >KIA Exclusive</td>';
    	}else if(idx == 5){
            hPrint = '<td >KIA Exclusive (%)</td>';
    	}else if(idx == 6){
            hPrint = '<td >3S Dealer</td>';
    	}else if(idx == 7){
    		hPrint = '<td >3S Dealer (%)</td>';
    	}else if(idx == 8){
    		hPrint = '<td colspan="2" class="active" >Outlet</td>';
    	}else if(idx == 9){
    		hPrint = '<td colspan="2" class="active" >Sub Dealer</td>';
    	}else if(idx == 10){
    		hPrint = '<td colspan="3" class="active" >Point of Sales</td>';
    	}else if(idx == 11){
    		hPrint = '<td colspan="3" class="active" >Service Only Points(2S)</td>';
    	}else if(idx == 12){
    		hPrint = '<td colspan="3" >Total Number of Dealers</td>';
    	}else if(idx == 13){
    		hPrint = '<td colspan="3" class="active" >SI Plan/Result in Year</td>';
    	}else if(idx == 14){
    		hPrint = '<td colspan="3" class="active" >Cumulative Active SI Installations</td>';
    	}else if(idx == 15){
            hPrint = '<td colspan="1" rowspan="5" class="active" >&nbsp;</td>';
            hPrint += '<td colspan="2" class="active" >Applied Rate (%)</td>';
    	}else if(idx == 16){
            hPrint = '<td rowspan="4" ></td>';
            hPrint += '<td >Chrome Symbol (Aggregated)</td>';
    	}else if(idx == 17){
            hPrint = '<td style="float: right;">Applied Rate</td>';
    	}else if(idx == 18){
            hPrint = '<td >Full Red Cube (Aggregated)</td>';
    	}else if(idx == 19){
            hPrint = '<td style="float: right;">Applied Rate</td>';
    	}else if(idx == 20){
            hPrint = '<td rowspan="3" class="active" ></td>';
            hPrint += '<td colspan="2" class="active" >Dealer Terminated Total</td>';
    	}else if(idx == 21){
    		hPrint = '<td rowspan="2" ></td>';
            hPrint += '<td >SI Not Applied</td>';
    	}else if(idx == 22){
    		hPrint = '<td>SI Applied</td>';
    	}
